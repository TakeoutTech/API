...
1 Open the file [installation path]\POSIintegrationClient.exe.config

 * change the site id to _______.


2 Open the file is under [installation path]\TakeOut Technologies POS Integration Service\POSIintegrationClient.exe.config

 * Where you see  value=”DEMO”, change it to value=“________” 


3 under [installation path]\TakeOut Technologies POS Integration Service
